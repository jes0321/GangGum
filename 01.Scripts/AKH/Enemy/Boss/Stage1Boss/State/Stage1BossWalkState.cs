...
public class Stage1BossWalkState : EnemyState
{
    public Stage1BossWalkState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName) : base(enemy, stateMachine, animBoolName)
    {
    }
